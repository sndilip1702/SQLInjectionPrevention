...
public class CustomResultSet implements ResultSet {
    ...
    private ResultSet customResultSet;

    public CustomResultSet(Statement parentStatement, ResultSet wrappedResultSet) {
        this.parentStatement = parentStatement;
        this.customResultSet = wrappedResultSet;
    }

    @Override
    public boolean next() throws SQLException {
        return customResultSet.next();
    }
    ...
    public <T> T unwrap(Class<T> iface) throws SQLException {
        try {
            ...
            return customResultSet.unwrap(iface);
    ...
    public boolean isWrapperFor(Class<?> iface) throws SQLException {
        ...
        return customResultSet.isWrapperFor(iface);
    }
}
